...
const ViewJournalPage: React.FC<ViewJournalPageProps> = ({
  journal,
  onBack,
}) => {
  ...
  const handleShareToInstagram = (imgDataUrl: string) => {
    ...
    if (/Android|iPhone|iPad|iPod/i.test(ua)) {
      ...
      const url = `intent://share?backgroundImage=${encodeURIComponent(
        imgDataUrl
  ...
  return (
    ...
    >
      ...
      <SharePosterModal
        ...
        movieOriginalTitle={
          journal?.original_title && journal.original_title.trim()
            ? journal.original_title
            : journal?.movieTitle
        }
      ...
      {journal.backdrops && journal.backdrops.length >= 2 && (
        ...
        >
          <img
            src={
              journal.backdrops[
                journal.backdrops.length === 2
                  ? 1
                  : journal.backdrops.length - 1
              ]
            }
            alt="backdrop"
            style={{
      ...
      <div className="credits-block-detail credits-block-custom">
        ...
        <div className="credits-table">
          ...
          <div className="credits-value">
            {journal.original_title || journal.movieTitle}
          </div>
          ...
          <div className="credits-value">
            {Array.isArray(journal.cast)
              ? journal.cast.slice(0, 3).join(", ")
              : ""}
          </div>
