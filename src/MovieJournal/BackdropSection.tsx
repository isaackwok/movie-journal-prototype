...
const BackdropSection: React.FC<BackdropSectionProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        Select the most memorable scenes.
      </div>
      <div style={{ width: "100%", marginTop: 16 }}>
        <div
          style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4 }}
        >
          {(backdrops.length <= 6 ? backdrops : backdrops.slice(0, 6)).map(
            (img, idx) => {
                ...
                <div
                  ...
                  onClick={() => {
                    if (isViewMore) {
                      ...
                      setSelectedBackdrops(
                        isSelected
                          ? selectedBackdrops.filter((i) => i !== img)
                          : [...selectedBackdrops, img],
                      );
                    }
                  }}
                >
                  ...
                  >
                    <img
                      ...
                      style={{
                        ...
                        display: "block",
                        borderRadius: 0,
                        filter: isViewMore ? "brightness(0.7)" : undefined,
                      }}
                    />
                  </div>
                  {/* 多選勾勾 */}
